                ...
                </Row>
                {
                    ...
                    ?   <Row className="justify-content-center mt-3">
                            <Col xs={10} md={4}>
                                ...
                                <p className={capitalLetter ? 'blueText' : ''}>- 1 Capital Letter</p>
                                <p className={lowerCase ? 'blueText' : ''}>- 1 Lower-Case Letter</p>
                                <p className={number ? 'blueText' : ''}>- 1 Number</p>
                                <p className={specialCharacter ? 'blueText' : ''}>- 1 Special Character</p>
                                <p className={charMin ? 'blueText' : ''}>- 8 Characters Total</p>
                            </Col>
                        </Row>
                    : <></>
                }
