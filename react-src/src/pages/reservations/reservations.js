...
function ReservationPage(props) {
    ...
    const options = [
        ...
        { label: 'At Americana 7-Night Week', value: 'At Americana 7-Night Week' },
        { label: 'At Americana Split Week', value: 'At Americana Split Week' },
    ...
    return (
        <div id='reservation-request'>
            ...
            <Container className="mb-3">
                {
                    ...
                    ?   <>
                        <p>Please complete the form below to request a reservation. 
                            An Americana reservationist will get back with you within two business days to confirm. 
                ...
                <p>- Need help with reservations? Read <a className="blueText" onClick={() => setShowFacts(!showFacts)}>Reservation Facts</a> or contact the front office for more information. We look forward to seeing you!</p>
                {
                    showFacts 
                    ?   <>
                            <h3>Reservation Facts:</h3>
                            <p>Make a reservation at the Americana in your unit type and season for a Sunday check-in. 
                            ...
                            <p>We want you to use and enjoy your vacation time!! 
                                Here’s an overview, but please call Paula at&nbsp;
                                <span className="blueText" onClick={() => window.open("tel:+18008225920")}><strong>1(800)822-5920</strong></span> 
                                &nbsp;if you have any questions.</p>
                            {
                                props.isAuthenticated
                                ?  <p>- Click here for the current <a className="blueText" target="_blank" href={calendarLink}>Americana Use Calendar</a></p>
                                : <></>
                            }
                        </>
                    : <></>
                }
                <p>- Click here to view other <a className="blueText" onClick={() => setShowReservation(!showReservation)}>Reservation Options</a></p>
            </Container>
            <Container>
                {
                    !showReservation
                        ?   <div id="reservationOptions">
                                ...
                                <p>Phone: <span className="blueText" onClick={() => window.open("tel:+18008225920")}><strong>1(800) 822-5920</strong></span></p>
                                <p>E-mail: <a className="blueText" href="mailto:res@americana-tahoe.com" target="_blank">res@americana-tahoe.com</a></p>
                                <p>Fax: (530) 541-1474</p>
                                <div id="addressBlock">
                                    <p>Mail to:</p>
                                    <ul>
                                        <li><p>Americana Vacation Club</p></li>
                                        <li><p>3845 Pioneer Trail</p></li>
            ...
            }
            {
                ...
                ?   <>
                        <Container>
                            <p>Click here to view our <a className="blueText" target={"_blank"} href={rulesLink}>Rules and Regulations</a>. 
                                ...
                                <span className="blueText" onClick={() => window.open("tel:+18002625077")}><strong>1(800)262-5077</strong></span> . 
                                For general Rules and Regulations questions, please call&nbsp;
                                <span className="blueText" onClick={() => window.open("tel:+5305448463")}><strong>(530)544-8463</strong></span>.</p>
                        </Container>
                    </>
                : <></>
            }
